 ...
 * on 2017-05-18 at 20:56:19 UTC 
 * Modify at your own risk.
 */

package com.example.assi.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokes-b0c68.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.example.assi.myapplication.backend.myApi.model.MyBean}
   * @return the request
   */
  public SetJoke setJoke(com.example.assi.myapplication.backend.myApi.model.MyBean content) throws java.io.IOException {
    SetJoke result = new SetJoke(content);
    initialize(result);
    return result;
  }

  public class SetJoke extends MyApiRequest<com.example.assi.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SetJoke(com.example.assi.myapplication.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.assi.myapplication.backend.myApi.model.MyBean.class);
    }
